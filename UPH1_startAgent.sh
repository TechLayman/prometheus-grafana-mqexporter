#!/bin/bash
export MQSERVER=PROM.SVRCONN/TCP/'server81(1414)'
...
#channels="MQDBK01.MQSBK01,MQVIEW.SVRCONN,PROLIFICS.SVRCONN,PROM.SVRCONN"
channels="*,!SYSTEM.*"
...
#ARGS="$ARGS -ibmmq.usePublications=false"
#ARGS="$ARGS -pollInterval=5s"
